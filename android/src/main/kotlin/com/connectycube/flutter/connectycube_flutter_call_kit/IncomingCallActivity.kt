...
fun createStartIncomingScreenIntent(
    ...
    callInitiatorName: String, opponents: ArrayList<Int>, userInfo: String, userImage: String,
): Intent {
    ...
    intent.putExtra(EXTRA_CALL_USER_IMAGE, userImage)
    return intent
}
...
class IncomingCallActivity : Activity() {
    ...
    private fun processIncomingData(intent: Intent) {
        ...
        userImage = intent.getStringExtra(EXTRA_CALL_USER_IMAGE)
    }
